...
################################################################################
"""
本文件的mixture of encoder-decoder model(med)结构, Based on BLIP code base
...
from timm.models.vision_transformer import PatchEmbed, Mlp, Attention, Block
...
class BertSelfAttention(nn.Module):
    ...
    def save_attn_gradients(self, attn_gradients):
        """save attention gradient"""
        self.attn_gradients = attn_gradients

    def get_attn_gradients(self):
        """get attention gradient"""
...
class BertModel(BertPreTrainedModel):
    ...
    def get_extended_attention_mask(self, attention_mask, input_shape, device, is_decoder):
        """
        ...
        if attention_mask.dim() == 3:
            ...
            # - if the model is an encoder, make the mask broadcastable [batch_size, num_heads, seq_length, seq_length]
            if is_decoder:
